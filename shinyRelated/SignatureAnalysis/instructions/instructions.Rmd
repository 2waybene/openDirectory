...
- The subset file's first column contains the regulator name. The second, third, and fourth columns are irrelevant. The fifth column are the genes of the regulator that are to be removed, listed in one cell and separated by commas, i.e. ABCA3,ABCC5,ACADM,ACPP,.... 
...
4. To use the *bootstrap* tab, steps 1-3 should already have been performed. Upload the subset file to the only file explorer in the tab. Enter in the number of random runs for the negative control (default = 1000). 
